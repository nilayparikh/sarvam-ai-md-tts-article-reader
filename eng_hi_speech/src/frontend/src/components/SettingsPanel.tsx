...
const SettingsPanel: React.FC = () => {
  ...
  const handleGenerate = async () => {
    ...
    if (isUploadMode && uploadedFile) {
      ...
      try {
        const writeResponse = await writeMarkdownFile({
          ...
          overwrite: true, // Overwrite to ensure latest content is used
        });
    ...
    try {
      ...
      setError("Failed to generate TTS. Check console for details.");
    } finally {
        ...
        <CardContent>
          ...
          <Box sx={{ mb: 2 }}>
            ...
            <Slider
              ...
              onChange={(_, value) => setTTSSettings({ pace: value as number })}
              min={0.5}
              max={2.0}
              step={0.1}
              marks={[
            ...
            <AccordionDetails sx={{ p: 0 }}>
              ...
              <Box sx={{ mb: 2 }}>
                ...
                <Slider
                  ...
                  onChange={(_, value) =>
                    setTTSSettings({ heading_loudness_boost: value as number })
                  }
                  min={1.0}
                  max={1.5}
                  step={0.1}
              ...
              <Box sx={{ mb: 2 }}>
                ...
                <Slider
                  ...
                  onChange={(_, value) =>
                    setTTSSettings({ pause_after_heading_ms: value as number })
                  }
                  min={0}
                  max={2000}
                  step={100}
            ...
            >
              <TableBody>
                ...
                <TableRow>
                  ...
                  <TableCell align="right" sx={{ fontWeight: 600, pr: 0 }}>
                    {(generationSummary.total_bytes_sent / 1024).toFixed(2)} KB
                  </TableCell>
                </TableRow>
                <TableRow>
                  <TableCell sx={{ color: "text.secondary", pl: 0 }}>
                ...
                <TableRow>
                  ...
                  <TableCell align="right" sx={{ fontWeight: 600, pr: 0 }}>
                    {(generationSummary.total_duration_ms / 1000).toFixed(2)} s
                  </TableCell>
                </TableRow>
                <TableRow>
                  <TableCell sx={{ color: "text.secondary", pl: 0 }}>
